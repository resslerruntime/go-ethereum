  ...
  function n(e) {
      ...
      if (null != n && H(n, 2, 64, M, "base")) {
        ...
        o
          ? ((f.s = 0 > 1 / e ? ((s = s.slice(1)), -1) : 1),
            j && s.replace(/^0\.0*|\./, "").length > 15 && L(M, b, e),
            (o = !1))
    ...
    return (
        ...
        return function(i, o, u, s, f) {
          ...
          for (
            v = new a(F),
              ...
              c = i.e - o.e,
              F = u + c + 1,
              f || ((f = N), (c = t(i.e / y) - t(o.e / y)), (F = (F / y) | 0)),
              h = 0;
            L[h] == (I[h] || 0);
            h++
          );
                ...
                0 > l
                  ? ((R = O[0]),
                    ...
                    -1 == l &&
                      ((S = O.length),
                      (l = n(L, O, _, S)),
                      1 > l && (p++, r(O, S > _ ? x : L, S, f))),
                    (S = O.length))
                  : 0 === l && (p++, (O = [0])),
                (b[h++] = p),
                l && O[0] ? (O[S++] = I[A] || 0) : ((O = [I[A]]), (S = 1));
      ...
      (T.round = function(e, n) {
        ...
        return (
          (null == e || H(e, 0, E, 15)) &&
            U(t, ~~e + this.e + 1, null != n && H(n, 0, 8, 15, v) ? 0 | n : k),
          t
        );
      }),
      (T.shift = function(e) {
